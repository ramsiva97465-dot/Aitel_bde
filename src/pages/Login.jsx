  ...
  return (
    <div className="min-h-screen bg-white flex flex-col md:flex-row font-poppins">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12 lg:p-20 relative overflow-hidden">
        ...
        <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-brand-50 rounded-full opacity-50 blur-3xl pointer-events-none" />

        <div className="w-full max-w-sm relative z-10 text-center md:text-left">
          {/* Brand Logo - Centered */}
          ...
          <div className="mb-10 text-center">
            <h1 className="text-4xl font-extrabold text-gray-700 mb-2">Welcome back</h1>
            <p className="text-gray-500 font-medium">Please enter your details.</p>
          </div>

          {error && (
            <div className="mb-6 px-4 py-3 bg-red-50 border border-red-100 text-red-600 rounded-xl text-sm font-medium animate-shake text-left">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5 text-left">
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 border-gray-300 rounded text-brand-600 focus:ring-brand-500 transition-all" />
                <span className="text-sm font-bold text-gray-600 group-hover:text-gray-700 transition-colors">Remember me</span>
              </label>
              <button type="button" className="text-sm font-bold text-brand-600 hover:underline underline-offset-4 decoration-2">
                Forgot password
              </button>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-sm text-gray-500 font-medium">
              ...
              <button className="text-brand-600 font-bold hover:underline underline-offset-4 decoration-2">
      ...
      {/* Right Side — Solid Blue & Features */}
